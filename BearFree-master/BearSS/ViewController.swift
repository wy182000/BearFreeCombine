...
class ViewController: FormViewController {
    ...
    let defaultStand = UserDefaults.init(suiteName: "group.com.v.demo")
    ...
    func updateConnectButton(){
        ...
        VpnManager.shared.ip_address = "42.157.225.2" //defaultStand!.string(forKey: userConfig().ip) ?? ""
        VpnManager.shared.port = 25956 //Int(defaultStand!.string(forKey: userConfig().port) ?? "0")!
        VpnManager.shared.password = "qb8e5jY45zBLkWaz5f" //defaultStand!.string(forKey: userConfig().password) ?? ""
        VpnManager.shared.algorithm = "AES256CFB" //defaultStand!.string(forKey: userConfig().algorithm) ?? ""
    }
